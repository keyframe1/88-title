...
import { getCustomerDetail } from "@/lib/records/dal";
import type { CustomerDetail } from "@/lib/records/types";
import { SignOutButton } from "@/components/dealers/SignOutButton";
import { CustomerDetailView } from "@/components/staff/RecordDetail";
...
export default async function StaffCustomerDetailPage({
  ...
  // record doesn't exist (or was deleted). Handle each with a clear notice rather
  // than a broken page.
  ...
  try {
    ...
    console.error("Customer detail unavailable:", err);
    loadError = true;
  }
